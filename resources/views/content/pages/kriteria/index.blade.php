...
@section('content')
    ...
    <div class="text-end mb-3">
        <a href="/kriteria/create" class="btn btn-dark">Tambah Kriteria</a>
    </div>
    <div class="card p-3">
                        ...
                        @foreach ($data as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">{{ $item->bobot }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="ms-2 d-flex flex-column justify-content-center">
                                            <form id="delete-form-{{ $item->id }}"
                                                action="/kriteria/{{ $item->id }}" method="POST" role="form text-left"
    ...
    <script>
        function hapusData(id) {
            Swal.fire({
                ...
                text: "Kriteria akan dihapus secara permanen!",
                icon: "warning",
